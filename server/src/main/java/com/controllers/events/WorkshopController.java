...
@RestController
@CrossOrigin
@RequestMapping("api/public/workshop")
public class WorkshopController {
    ...
    public BatchResponseDto<List<EventResponseDto>> getWorkshops() {
    ...
    public BatchResponseDto<List<DetailedEventResponseDto>> getMostRecentWorkshops() {
